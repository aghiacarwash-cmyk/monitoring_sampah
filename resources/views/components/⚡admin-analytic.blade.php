...
public $containers;
    ...
    public function handleUpdate()
    {
        ...
        // Kirim data terbaru ke JS supaya chart bisa di-update tanpa reload
        $this->dispatch('charts-updated', [
            'kosong' => $this->containers->whereBetween('persen', [0, 10])->count(),
            'berisi' => $this->containers->whereBetween('persen', [11, 80])->count(),
            'penuh'  => $this->containers->where('persen', '>=', 81)->count(),
        ]);
    }

    private function loadData()
    {
        $this->containers = Container::with(['kecamatan', 'kelurahan'])->get();
    }
    };
?>
